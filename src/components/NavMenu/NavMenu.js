...
// Link icons:
const icSection1 = <svg className='nav-menu__links__link__icon' xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>;
...
const icSection5 = <svg className='nav-menu__links__link__icon' xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-120v-680h360l16 80h224v400H520l-16-80H280v280h-80Zm300-440Zm86 160h134v-240H510l-16-80H280v240h290l16 80Z"/></svg>;
const icSection6 = <svg className='nav-menu__links__link__icon' xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-320 280-520l56-58 104 104v-326h80v326l104-104 56 58-200 200ZM240-160q-33 0-56.5-23.5T160-240v-120h80v120h480v-120h80v120q0 33-23.5 56.5T720-160H240Z"/></svg>;
...
// Guest user icon:
const guestUserIcon = <svg className='nav-menu__user-container__user-icon' width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 37.6667C29.757 37.6667 37.6666 29.757 37.6666 20C37.6666 10.243 29.757 2.33334 20 2.33334C10.243 2.33334 2.33331 10.243 2.33331 20C2.33331 29.757 10.243 37.6667 20 37.6667Z" fill="#D9D9D9"/><path d="M33 31C32.0464 32.7553 30.2847 34.2745 27.957 35.3488C25.6292 36.4232 22.8495 37 20 37C17.1505 37 14.3708 36.4232 12.043 35.3488C9.71526 34.2745 7.95356 32.7553 7 31" fill="#868E96"/><path d="M7.12122 32.0933C8.06588 29.4331 9.81115 27.1307 12.1172 25.5024C14.4233 23.8742 17.177 23 20 23C22.8229 23 25.5767 23.8742 27.8827 25.5024C30.1888 27.1307 31.9341 29.4331 32.8787 32.0933" fill="#868E96"/><path d="M20 23C24.2342 23 27.6666 19.5675 27.6666 15.3333C27.6666 11.0991 24.2342 7.66666 20 7.66666C15.7658 7.66666 12.3333 11.0991 12.3333 15.3333C12.3333 19.5675 15.7658 23 20 23Z" fill="#868E96"/></svg>;
